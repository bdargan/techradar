...
{ name: 'Docker',
 ...
 { name: 'Android Studio',
  ...
  { name: 'Hystrix',
    pc: { r: 150, t: 36 },
    movement: 'c' },
  { name: 'Mustache and Handlebars templates',
    pc: { r: 50, t: 22 },
    movement: 'c',
    domain: 'template' },
  { name: 'OpenId Connect authenticated internal APIs',
    pc: { r: 80, t: 64 },
    movement: 'c',
    domain: 'back-end' } 
        ]
